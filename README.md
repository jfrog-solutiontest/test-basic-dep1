# Dependency for Basic Test Module
> This dependencies has no file or gopkg file and it has a dependency on another module which
> also does not have a go.mod file.  This dependency creates a transitive dependency for the basic 
> go test module. Also this README file also have additional Readme text for further ReadMe testing. 

## Some Test case
* gocenter to create proposed go.mod file 
* UsedBy testing - this module is used by basic.go test module
* License check is Apache
* This module will go thru the processing API  
